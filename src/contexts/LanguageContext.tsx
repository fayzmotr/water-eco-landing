...
const translations = {
  en: {
    ...
    // Home Page
    'home.hero.badge': 'Leading Water & Wastewater Treatment Solutions',
    'home.hero.title': 'Clean Water',
    'home.hero.titleHighlight': 'Advanced Treatment',
    'home.hero.subtitle': 'Comprehensive water and wastewater treatment solutions from 20 m³/day to 1,000,000 m³/day. We design, construct, and reconstruct treatment facilities for municipalities, industries, and communities.',
    'home.hero.exploreSolutions': 'Explore Solutions',
    'home.hero.getConsultation': 'Get Consultation',
    ...
    'home.solutions.title': 'Complete Water Treatment Solutions',
    'home.solutions.subtitle': 'From small settlements to large cities, we provide comprehensive water and wastewater treatment systems with proven efficiency and reliability',
    'home.solutions.filtration.title': 'Wastewater Treatment Plants',
    'home.solutions.filtration.desc': 'Complete biological and physical-chemical treatment systems for municipal and industrial wastewater',
    'home.solutions.monitoring.title': 'Water Purification Systems',
    'home.solutions.monitoring.desc': 'Advanced drinking water treatment with turbidity, color, and contaminant removal capabilities',
    'home.solutions.standards.title': 'Modular Treatment Units',
    'home.solutions.standards.desc': 'Block-modular systems from 2-19 m³/h with factory-ready automation and remote control',
    'home.solutions.sustainable.title': 'BioSteps BS Systems',
    'home.solutions.sustainable.desc': 'Five-stage biological treatment achieving 98-99% efficiency for residential and commercial applications',
    ...
    // About Page
    'about.hero.badge': 'About Our Company',
    'about.hero.title': 'Water Treatment',
    'about.hero.titleHighlight': 'Specialists',
    'about.hero.subtitle': 'Five years of dedicated service in water and wastewater treatment, delivering over 20 successful projects across Uzbekistan with cutting-edge technology and proven results',
    'about.hero.subtitle': 'Eight years of dedicated service in water and wastewater treatment, delivering over 20 successful projects across Uzbekistan with cutting-edge technology and proven results',

    'about.journey.title': 'Our Journey',
    'about.mission.title': 'Our Mission',
    'about.mission.content': 'To provide comprehensive water and wastewater treatment solutions that protect public health and the environment. We specialize in designing, constructing, and reconstructing treatment facilities that meet the highest standards of efficiency and reliability.',
    'about.vision.title': 'Our Vision',
    'about.vision.content': 'To be the leading water treatment company in Central Asia, known for innovative solutions, exceptional service, and sustainable environmental practices. We envision clean water access for all communities through advanced treatment technologies.',

    'about.values.title': 'Our Core Values',
    'about.values.subtitle': 'The principles that guide our water treatment solutions and client relationships',
    'about.values.quality.title': 'Technical Excellence',
    'about.values.quality.desc': 'Delivering 98-99% treatment efficiency with state-of-the-art equipment and proven methodologies',
    'about.values.partnership.title': 'Client Partnership',
    'about.values.partnership.desc': 'Building long-term relationships through reliable service and comprehensive project support',
    'about.values.innovation.title': 'Innovation Leadership',
    'about.values.innovation.desc': 'Implementing advanced technologies like ultrafiltration membranes and automated control systems',
    'about.values.sustainability.title': 'Environmental Focus',
    'about.values.sustainability.desc': 'Protecting natural resources through efficient treatment and sustainable practices',

    'about.team.title': 'Expert Team',
    'about.team.subtitle': 'Experienced professionals in water treatment engineering and project management',

    'about.certifications.title': 'Certifications & Standards',
    'about.certifications.subtitle': 'Our commitment to quality and compliance in water treatment',

    // Catalogue Page
    'catalogue.hero.badge': 'Water Treatment Solutions',
    'catalogue.hero.title': 'Complete Treatment Systems',
    'catalogue.hero.subtitle': 'Comprehensive water and wastewater treatment solutions from small residential systems to large municipal facilities',
    ...
    'pricing.hero.badge': 'Our Services',
    'pricing.hero.title': 'Water Treatment Services',
    'pricing.hero.subtitle': 'Comprehensive services from design and construction to maintenance and support for all your water treatment needs',

    'pricing.tiers.title': 'Choose Your Service Package',
    'pricing.tiers.subtitle': 'Select the service level that best fits your project requirements',
    'pricing.tiers.standard': 'Basic Design',
    'pricing.tiers.professional': 'Complete Solution',
    'pricing.tiers.enterprise': 'Full Service',
    'pricing.tiers.popular': 'Most Popular',

    'pricing.systems.title': 'Treatment System Capacities',
    'pricing.systems.subtitle': 'Our systems handle everything from small residential to large municipal applications',
    'pricing.access.title': 'Custom Project Consultation',
    'pricing.access.subtitle': 'Every water treatment project is unique. Contact our engineering team for a detailed consultation and custom solution design.',
    'pricing.access.request': 'Request Consultation',
    'pricing.access.contact': 'Contact Engineering Team',

    'pricing.custom.title': 'Need a Custom Solution?',
    'pricing.custom.subtitle': 'We offer complete design-build services, from initial assessment to final commissioning. Contact our technical team for a personalized consultation.',
    'pricing.custom.contact': 'Contact Technical Team',
    'pricing.custom.download': 'Download Brochure',
    ...
    'contact.hero.title': 'Contact Our Engineers',
    'contact.hero.subtitle': 'Ready to discuss your water treatment needs? Our team of engineers is here to provide consultation, design services, and technical support.',
    ...
    // Footer
    'footer.company.tagline': 'Water & Wastewater Treatment',
    'footer.company.description': 'Specialized provider of comprehensive water and wastewater treatment solutions, from design and construction to maintenance and support for municipal and industrial applications.',
  ...
  ru: {
    ...
    'about.hero.subtitle': 'Восемь лет преданного служения в области очистки воды и сточных вод, реализация более 20 успешных проектов по всему Узбекистану с передовыми технологиями и проверенными результатами',
  ...
  uz: {
    ...
    'about.hero.subtitle': 'Suv va oqova suvlarini tozalash sohasida sakkiz yillik fidokorlik bilan xizmat, ilg\'or texnologiyalar va isbotlangan natijalar bilan O\'zbekiston bo\'ylab 20 dan ortiq muvaffaqiyatli loyihalarni amalga oshirish',
